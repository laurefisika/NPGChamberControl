...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .criticalGrid { display:grid; grid-template-columns:repeat(2,1fr); gap:8px; }
    ...
    <header class="card header">
      ...
      <div>
        <div class="runSummary">
          ...
          <div class="summaryItem"><span>Interlock</span><strong id="headerInterlock">--</strong></div>
        </div>
        ...
        <div class="card section criticalCard">
          ...
          <div class="criticalGrid">
            <div class="metric wide">
              <div class="modeRow"><div><div class="metricLabel">COSCON mode</div><div id="cosconMode" class="metricValue">--</div></div><div id="updatedAt" class="pill">No telemetry</div></div>
              <div id="cosconDetails" class="metricSub">No status details yet</div>
            </div>
            <div class="metric"><div class="metricLabel">Safety interlock</div><div id="interlockVal" class="metricValue">--</div><div id="interlockSub" class="metricSub">Waiting for safety-chain status</div></div>
        ...
        <div class="detailsStack">
          ...
          <details class="card">
            ...
            <div class="detailsBody">
              ...
              <div class="interlockHelp"><strong>INTERLOCK:</strong> the external hardware safety permission. <strong>OK</strong> permits operation; <strong>Tripped</strong> means activation must remain blocked or stopped.</div>
            </div>
          </details>
        </div>
      </section>
