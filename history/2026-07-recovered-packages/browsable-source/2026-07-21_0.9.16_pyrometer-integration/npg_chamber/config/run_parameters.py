...
PYROMETER_PARAMETER_SPECS: tuple[ParameterSpec, ...] = (
    ParameterSpec(
        ...
        kind="bool",
        group="Availability",
        description="Read COM10 during Phases 01 and 03. A missing pyrometer is logged as unavailable and does not stop the phase.",
    ),
    ParameterSpec(
        "profile_name",
        "Calibration profile",
        "Au/mica — validated",
        kind="choice",
        choices=("Au/mica — validated", "Custom material"),
        group="Material profile",
        description="The validated Au/mica profile uses the filtered calibration from 160 °C sample / 90 °C pyrometer upward.",
    ),
    ParameterSpec(
        "emissivity_percent",
        ...
        unit="%",
        group="Material profile",
        description="Written once and verified at phase startup when enabled. Changing it requires a matching calibration profile.",
        minimum=10.0,
        maximum=100.0,
    ),
    ParameterSpec(
    ...
    ParameterSpec(
        ...
        unit="°C",
        group="Sample-temperature calibration",
        description="Below this raw pyrometer value, T_sample is logged as NaN and shown as below calibrated range.",
        minimum=50.0,
        maximum=1200.0,
    ),
    ParameterSpec(
    ...
    ParameterSpec(
        ...
        group="Display",
        description="Initial curve shown in the shared temperature graph. It can be changed live in Phases 01 and 03.",
    ),
)
