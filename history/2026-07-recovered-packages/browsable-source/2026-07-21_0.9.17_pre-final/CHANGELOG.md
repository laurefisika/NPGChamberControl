...
## 0.9.17 - Current integrated build

### Parameter-editor usability and Phase 01/03 workflow separation

- Made **Change automatization parameters** a normal resizable/maximizable window. It opens maximized where supported and keeps the standard Maximize/Restore title-bar control.
...
- Kept the internal project version at `0.9.17`, preserved the original four-script backup unchanged and retained the existing serial-port handoff protections.
