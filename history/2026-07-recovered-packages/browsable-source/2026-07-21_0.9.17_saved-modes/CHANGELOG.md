...
### Full-chamber automation modes and Phase 01/03 layout refinement (same 0.9.17 version)
...
### Phase 01/03 visual harmonization and cleanup (same 0.9.17 version)
...
### Original 0.9.17 functional changes
