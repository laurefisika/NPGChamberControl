...
<head>
  ...
  <style>
    ...
    :root {
      ...
      --cyan:#2f9fb3;
      --pink:#d66d91;
      --shadow:0 8px 24px rgba(35,54,75,.09);
    }
    ...
    * { box-sizing:border-box; }
    ...
    .accent-violet { border-top:4px solid #8b70d8; }
    .accent-blue   { border-top:4px solid #5b8def; }
    .accent-cyan   { border-top:4px solid #2f9fb3; }
    .accent-amber  { border-top:4px solid #e99a32; }
    .accent-pink   { border-top:4px solid #d66d91; }
    .accent-green  { border-top:4px solid #2ca66f; }
    .accent-slate  { border-top:4px solid #7a8ca2; }
    ...
    .title { font-size:23px; font-weight:950; letter-spacing:.1px; color:#203247; }
    .subtitle { margin-top:3px; color:var(--muted); font-size:10.5px; line-height:1.3; }

    .topStats { display:grid; grid-template-columns:repeat(4,minmax(105px,1fr)); gap:7px; }
    .topStat {
      padding:7px 9px;
    ...
    .topStat small { display:block; margin-top:2px; color:#8a9aae; font-size:7.5px; }
    ...
    .progressMeta { display:flex; justify-content:space-between; gap:12px; color:var(--muted); font-size:8.5px; margin-top:3px; }

    .main {
      min-height:0;
      overflow:hidden;
      display:grid;
      grid-template-columns:minmax(305px,.83fr) minmax(425px,1.17fr) minmax(310px,.85fr);
      gap:9px;
    }
    .column { min-height:0; overflow:hidden; display:flex; flex-direction:column; gap:9px; }
    .section { padding:9px 11px; overflow:hidden; }
    .sectionHeader { display:flex; align-items:center; justify-content:space-between; gap:8px; margin-bottom:7px; }
    .sectionTitle {
      font-size:11px;
      font-weight:950;
      letter-spacing:.9px;
    ...
    .stepName { font-size:9.8px; font-weight:900; }
    .stepDesc { color:var(--muted); font-size:7.7px; margin-top:1px; line-height:1.15; }
    .stepTime { color:#61748b; font-size:7.7px; font-weight:850; text-align:right; max-width:76px; }

    .timeCard { flex:0 0 auto; }
    .timerGrid { display:grid; grid-template-columns:repeat(2,1fr); gap:6px; }
    .timerCard { padding:7px 8px; border-radius:11px; background:#f7fafc; border:1px solid #e2e9f2; }
    .timerCard span { display:block; color:var(--muted); font-size:7.4px; font-weight:950; letter-spacing:.55px; text-transform:uppercase; margin-bottom:2px; }
    .timerCard strong { font-size:16px; font-weight:950; }
    .timerNote { margin-top:5px; color:var(--muted); font-size:7.9px; line-height:1.25; }
    ...
    .stageBadge {
      ...
      font-size:8px; font-weight:950; letter-spacing:.7px; text-transform:uppercase;
    }
    .stageText { margin-top:7px; font-size:16px; font-weight:950; }
    .stageDetails { margin-top:4px; color:var(--muted); font-size:9.5px; line-height:1.3; white-space:pre-line; }
    .prompt {
      margin-top:7px; padding:9px; min-height:58px; border-radius:11px;
      background:#f7f9fc; border:1px solid #dfe7f0;
      font-size:10.5px; line-height:1.32; white-space:pre-line;
    }
    .actions { display:flex; flex-wrap:wrap; gap:6px; margin-top:7px; }
    .noAction { flex:1; padding:8px; border-radius:10px; border:1px dashed #cbd7e5; color:var(--muted); text-align:center; font-size:8.8px; }
    button {
      min-width:116px; padding:8px 11px; border:1px solid rgba(0,0,0,.05); border-radius:10px;
    ...
    .metric { padding:7px 8px; border-radius:11px; background:#f8fafc; border:1px solid #e1e8f1; min-width:0; }
    .metric.wide { grid-column:1 / -1; }
    .metricLabel { color:var(--muted); font-size:7.5px; font-weight:950; letter-spacing:.65px; text-transform:uppercase; margin-bottom:2px; }
    .metricValue { font-size:14px; font-weight:950; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
    .metricSub { margin-top:2px; color:var(--muted); font-size:7.7px; line-height:1.2; }

    .ok { color:#238e60; }
    .bad { color:#c94752; }
    .warningText { color:#b36b18; }

    .pidBox { padding:8px; border-radius:11px; border:1px solid #cfdff8; background:#f3f7fe; font-size:8.8px; }
    ...
    .pidStatus { margin-top:5px; color:#46688f; font-size:8px; line-height:1.25; }

    .errorBox { min-height:38px; padding:8px; border-radius:11px; border:1px solid #ccebdd; background:#f2fbf7; color:#247d55; font-size:8.5px; line-height:1.3; white-space:pre-line; }
    .errorBox.active { border-color:#f0c5ca; background:#fff5f6; color:#ad3e48; }
    .footer { color:var(--muted); font-size:8.2px; line-height:1.35; padding:0 1px; }
    .interlockHelp { margin-top:6px; padding:7px 8px; border-radius:10px; background:#f6f4fd; border:1px solid #ddd5f6; color:#655486; font-size:7.9px; line-height:1.28; }

    @media (max-width:1180px), (max-height:760px) {
      html, body { height:auto; min-height:100%; overflow:auto; }
      .shell { height:auto; min-height:100vh; }
      .header { grid-template-columns:1fr; }
      .main { overflow:visible; grid-template-columns:1fr 1fr; }
      .column { overflow:visible; }
      .rightColumn { grid-column:1 / -1; display:grid; grid-template-columns:1fr 1fr; }
      .workflowCard { min-height:480px; }
    }
