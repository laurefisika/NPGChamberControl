...
## 0.9.17 - Saved pyrometer modes, verified emissivity readback and reduced Phase 02 density
...
- Added `CHECK_PYROMETER_EMISSIVITY.bat` and `diagnostic_tools/check_pyrometer_emissivity.py`. The diagnostic shows the complete parameter reply before and after a guarded change, confirms the emissivity readback and always closes COM10.
